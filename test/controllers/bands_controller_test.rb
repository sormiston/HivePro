...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { font: @band.font, name: @band.name, num_members: @band.num_members } }, as: :json
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { font: @band.font, name: @band.name, num_members: @band.num_members } }, as: :json
    assert_response 200
  end
